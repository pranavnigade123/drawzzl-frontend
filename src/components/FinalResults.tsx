      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4 md:p-8 py-8">
        <div className="max-w-4xl w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 max-w-2xl mx-auto animate-fadeIn">
            ...
            <button
              onClick={onQuit}
              className="flex-1 py-3 md:py-4 px-6 md:px-8 rounded-xl bg-gradient-to-r from-purple-500 to-pink-600 text-white font-bold text-base md:text-lg shadow-2xl hover:scale-105 active:scale-95 transition-transform flex items-center justify-center gap-2"
            >
