  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-linear-to-br from-purple-900/90 to-indigo-900/90 rounded-3xl p-8 max-w-md w-full border border-white/20 shadow-2xl"
      ...
      >
            ...
            return (
              <motion.div
                ...
                className={`flex items-center justify-between p-4 rounded-xl border transition-all ${
                  isWinner
                    ? 'bg-linear-to-r from-yellow-500/20 to-amber-500/20 border-yellow-400/50 shadow-lg shadow-yellow-500/20'
        ...
        <button
          onClick={handlePlayAgain}
          className="w-full py-3 bg-linear-to-r from-green-500 to-emerald-600 text-white font-bold rounded-xl hover:scale-105 active:scale-95 transition shadow-lg flex items-center justify-center gap-2"
        >
